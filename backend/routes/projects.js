...
router.put('/:id', protect, async (req, res) => {
  try {
    ...
    await project.update({
      ...
      hours_budget_total: req.body.hours_budget_total !== undefined ? req.body.hours_budget_total : project.hours_budget_total,
hours_budget_used: req.body.hours_budget_used !== undefined ? req.body.hours_budget_used : project.hours_budget_used,
per_diem_total: req.body.per_diem_total !== undefined ? req.body.per_diem_total : project.per_diem_total,
per_diem_used: req.body.per_diem_used !== undefined ? req.body.per_diem_used : project.per_diem_used,
